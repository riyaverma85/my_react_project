...
const RippleGrid = ({
  enableRainbow = false,
  gridColor = '#ffffff', // Grid lines color (white)
...
void main() {
    ...
    vec3 bgColor = vec3(0.0, 0.0, 0.0); // pure black
    vec3 finalColor = mix(bgColor, color * t, alpha);
  ...
  return (
    <div
      ref={containerRef}
      className="w-full h-full relative overflow-hidden bg-[#000000] [&_canvas]:block"
    />
  );
};
